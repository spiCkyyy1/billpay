            ...
            <div class="footer-wrapper">
                <div class="footer-top">
                    <div>
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12 block-inline contact-footer">
                                <div class="footer-block">
                                    <div class="footer-block-title">
                ...
                <div class="footer-middle">
                    <div class="row">
                        ...
                        <div class="col-lg-10 newsletter-wrapper">
                ...
                <div class="footer-bottom">
                    <div>
                        <div class="row">
                            <div class="col-lg-8 col-md-8 align-content-center col-sm-12 col-xs-12 copyright-footer">
