...
@push('script')
    ...
    <script src="{{ asset('js/sendpayment.js') }}" ></script>
@endpush
...
{{--     role="tabpanel" aria-labelledby="manual-recovery">--}}
    <div class="container" id="sendpayment_container">
        @if (session('success'))
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        @if(count($companies) > 0)
                            ...
                            <select name="company_id" class="custom-select mr-sm-2" id="companies" v-model="selectedCompany" :disabled="disableCompanySelect">
...
{{--                                @endforeach--}}
                    ...
                    <div class="col-md-12">
                        <p>
                            ...
                            <input class="form-control form-control-sm border" id="amount" name="amount"
                                   type="text" :disabled="disableAmount" v-model="amount">
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <button class="btn btn-success" :disabled="disableBtn">Pay with PayPal</button>
                    </div>
                </div>
                @endif
            </form>
